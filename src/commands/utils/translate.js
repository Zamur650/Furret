...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    // Send result
      ...
      .setFooter(`${message.author.username}#${message.author.discriminator}`, client.users.cache.find(user => user.id === process.env.DEVELOPER_ID).displayAvatarURL({ dynamic: true }))  
      .setTimestamp()
