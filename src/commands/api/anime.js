      ...
      .then(response => {
        const Embed = new Discord.MessageEmbed()
          ...
          .addFields(
            ...
            { name: 'Episode count', value: response.data[0].attributes.episodeCount, inline: true },
            { name: 'Episode length', value: response.data[0].attributes.episodeLength, inline: true },
